...
// 命名空间：Takt.Fluent.Views.Logistics.Visitors.VisitorComponent
// 文件名称：VisitorForm.xaml.cs
// 创建时间：2025-01-20
...
namespace Takt.Fluent.Views.Logistics.Visitors.VisitorComponent;

/// <summary>
/// 访客表单窗口（新建/编辑访客）
/// </summary>
public partial class VisitorForm : Window
{
    private readonly ILocalizationManager? _localizationManager;
    private VisitorFormViewModel? _viewModel;

    /// <summary>
    /// 初始化访客表单窗口
    /// </summary>
    /// <param name="vm">访客表单视图模型</param>
    /// <param name="localizationManager">本地化管理器</param>
    public VisitorForm(VisitorFormViewModel vm, ILocalizationManager? localizationManager = null)
    {
        InitializeComponent();
